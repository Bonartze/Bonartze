...
-  Now really actively revise C++ and all its componets (CMake, GDB, QT, STL and so forth)
...
-  Also I know Python and Linux (Ubuntu 22.04) at the level of user active user.
